...
public class MinDivSum {
    ...
    public static void main(String[] args) {
        MinDivSum ob = new MinDivSum();
        System.out.println("1. Min. Difference Sum = " + ob.minimumDifference(new int[] { 7, 9, 5, 8, 1, 3 }));
        System.out.println("2. Min. Difference Sum = " + ob.minimumDifference(new int[] { 1, 2, 1, 1, 2, 1 }));
    }
}
