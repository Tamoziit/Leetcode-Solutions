...
public class PathsWithMaxScore {
    ...
    public static void main(String[] args) {
        PathsWithMaxScore ob = new PathsWithMaxScore();

        System.out.println("TEST CASE 1:");
        List<String> board_1 = List.of("E23", "2X2", "12S");
        int[] res_1 = ob.pathsWithMaxScore(board_1);
        System.out.println("Res = " + Arrays.toString(res_1));

        System.out.println("TEST CASE 2:");
        List<String> board_2 = List.of("E12", "1X1", "21S");
        int[] res_2 = ob.pathsWithMaxScore(board_2);
        System.out.println("Res = " + Arrays.toString(res_2));

        System.out.println("TEST CASE 3:");
        List<String> board_3 = List.of("E11", "XXX", "11S");
        int[] res_3 = ob.pathsWithMaxScore(board_3);
        System.out.println("Res = " + Arrays.toString(res_3));
    }
}
